      ...
      <div class="row"> 
       <div class="col-xs-12"> 
        <ul class="breadcrumb"> 
         ...
         <li class="active  avtive_bold">审核通过订单表</li> 
        </ul> 
        <!-- 检索  --> 
           ...
           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr> 
            ...
            <td class="center"> 
              ...
              <?php elseif($vo['audit_order_source'] == '2'): ?> 
                    <?php  echo "<font color='green'>"."单个"."</font>"; endif; ?>  
           </td> 
          <td class='center'> 
            ...
            <td class="center"><a href="<?php echo U('Audit/xiangqing');?>?k_id=<?php echo ($vo['audit_id']); ?>">查看详情</a></td>
