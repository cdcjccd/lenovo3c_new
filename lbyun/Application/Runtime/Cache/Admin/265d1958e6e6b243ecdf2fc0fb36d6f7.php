				...
				<div class="page-content">
					<div class="row">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo U('Admin/User/userAdd');?>">用户添加</a>
							</li>
							<!-- <li class="active  avtive_bold">填写编辑公司信息</li> -->
						</ul>
						<!-- 检索  -->
						<form action="<?php echo U('Admin/User/userList');?>" method="get" name="Form" id="Form">
						<table border="0" cellspacing="0" cellpading="0" class="table-nav-search">
							<tr>
								...
								<td>
									<span>用户姓名：</span>
									<input  name="userRealName"  value="" type="text"  />
								</td>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
							...
							<!-- 开始循环 -->
									...
									<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
											...
											<td class='center'><?php echo ($v['registerfrom']); ?></td>
