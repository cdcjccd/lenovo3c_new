...
<head>
	<!-- jsp文件头和头部 -->
		...
		<link rel="stylesheet" href="/lby/Public/Admin/ace/css/bootstrap.css" />
		<link rel="stylesheet" href="/lby/Public/Admin/ace/css/font-awesome.css" />
		<!-- page specific plugin styles -->
		<!-- text fonts -->
		<link rel="stylesheet" href="/lby/Public/Admin/ace/css/ace-fonts.css" />
		<!-- ace styles -->
		<link rel="stylesheet" href="/lby/Public/Admin/ace/css/ace.css" class="ace-main-stylesheet" id="main-ace-style" />
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/lby/Public/Admin/ace/css/ace-part2.css" class="ace-main-stylesheet" />
		<![endif]-->
		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="/lby/Public/Admin/ace/css/ace-ie.css" />
		<![endif]-->
		<!-- inline styles related to this page -->
		<!-- ace settings handler -->
		<script src="/lby/Public/Admin/ace/js/ace-extra.js"></script>
		<!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->
		<!--[if lte IE 8]>
		<script src="/lby/Public/Admin/ace/js/html5shiv.js"></script>
		<script src="/lby/Public/Admin/ace/js/respond.js"></script>
		<![endif]-->
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a class="navbar-brand">
						...
						<img src="/lby/Public/Admin/ace/images/logo.png">
...
<div id="sidebar" class="sidebar                  responsive">
		...
		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/lby/Public/Admin/ace/js/jquery.js'>"+"<"+"/script>");
		</script>
		<!-- <![endif]-->
		<!--[if IE]>
		<script type="text/javascript">
		 window.jQuery || document.write("<script src='/lby/Public/Admin/ace/js/jquery1x.js'>"+"<"+"/script>");
		</script>
		<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='/lby/Public/Admin/ace/js/jquery.mobile.custom.js'>"+"<"+"/script>");
		</script>
		<script src="/lby/Public/Admin/ace/js/bootstrap.js"></script>
		
		<!-- page specific plugin scripts -->

		<!-- ace scripts -->
		<script src="/lby/Public/Admin/ace/js/ace/elements.scroller.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.colorpicker.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.fileinput.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.typeahead.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.wysiwyg.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.spinner.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.treeview.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.wizard.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.aside.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.ajax-content.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.touch-drag.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.sidebar.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.sidebar-scroll-1.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.submenu-hover.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.widget-box.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.settings.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.settings-rtl.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.settings-skin.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.widget-on-reload.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.searchbox-autocomplete.js"></script>
		<!-- inline scripts related to this page -->

		<!-- the following scripts are used in demo only for onpage help and you don't need them -->
		<link rel="stylesheet" href="/lby/Public/Admin/ace/css/ace.onpage-help.css" />

		<script type="text/javascript"> ace.vars['base'] = '..'; </script>
		<script src="/lby/Public/Admin/ace/js/ace/elements.onpage-help.js"></script>
		<script src="/lby/Public/Admin/ace/js/ace/ace.onpage-help.js"></script>
