...
<head>
	<!-- jsp文件头和头部 -->
		...
		<meta charset="utf-8" />
		<title>Lenovo 3C</title>
		<meta name="description" content="" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
		<!-- bootstrap & fontawesome -->
		<link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/bootstrap.css" />
		<link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/font-awesome.css" />
		<!-- page specific plugin styles -->
		<!-- text fonts -->
		<link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/ace-fonts.css" />
		<!-- ace styles -->
		<link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/ace.css" class="ace-main-stylesheet" id="main-ace-style" />
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/ace-part2.css" class="ace-main-stylesheet" />
		<![endif]-->
		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/ace-ie.css" />
		<![endif]-->
		<!-- inline styles related to this page -->
		<!-- ace settings handler -->
		<script src="/lenovo3C/Public/Admin/ace/js/ace-extra.js"></script>
		<!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->
		<!--[if lte IE 8]>
		<script src="/lenovo3C/Public/Admin/ace/js/html5shiv.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/respond.js"></script>
		<![endif]-->
	...
	<!-- 即时通讯 -->
	<link rel="stylesheet" type="text/css" href="/lenovo3C/Public/Admin/plugins/websocketInstantMsg/ext4/resources/css/ext-all.css">
	<link rel="stylesheet" type="text/css" href="/lenovo3C/Public/Admin/plugins/websocketInstantMsg/css/websocket.css" />
	<script type="text/javascript" src="/lenovo3C/Public/Admin/plugins/websocketInstantMsg/ext4/ext-all-debug.js"></script>
	<script type="text/javascript" src="/lenovo3C/Public/Admin/plugins/websocketInstantMsg/websocket.js"></script>
	<!-- 即时通讯 -->
	...
	<body class="no-skin">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a class="navbar-brand">
						...
						<img src="/lenovo3C/Public/Admin/ace/images/logo.png">
	 ...
	 <script src="/lenovo3C/Public/Admin/static/login/js/jquery-1.11.1.js"></script>
	 <script type="text/javascript">
...
<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					<li class="">
						<a href="<?php echo U('Index/main');?>">
							...
							<span class="menu-text">Lenovo 3C</span>
						</a>
						<b class="arrow"></b>
					</li>
                ...
                <script type="text/javascript" src="/lenovo3C/Public/Admin/static/js/jquery-1.7.2.js"></script>
				<script type="text/javascript">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div style="padding-left: 70%;padding-top: 1px;">
							<div style="float: left;margin-top: 3px;"><img src="/lenovo3C/Public/Admin/static/images/loadingi.gif" /> </div>
		...
		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/lenovo3C/Public/Admin/ace/js/jquery.js'>"+"<"+"/script>");
		</script>
		<!-- <![endif]-->
		<!--[if IE]>
		<script type="text/javascript">
		 window.jQuery || document.write("<script src='/lenovo3C/Public/Admin/ace/js/jquery1x.js'>"+"<"+"/script>");
		</script>
		<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='/lenovo3C/Public/Admin/ace/js/jquery.mobile.custom.js'>"+"<"+"/script>");
		</script>
		<script src="/lenovo3C/Public/Admin/ace/js/bootstrap.js"></script>

		<!-- page specific plugin scripts -->

		<!-- ace scripts -->
		<!-- <script src="/lenovo3C/Public/Admin/ace/js/ace/elements.scroller.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.colorpicker.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.fileinput.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.typeahead.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.wysiwyg.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.spinner.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.treeview.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.wizard.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.aside.js"></script> -->
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.js"></script>
		<!-- <script src="/lenovo3C/Public/Admin/ace/js/ace/ace.ajax-content.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.touch-drag.js"></script> -->
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.sidebar.js"></script>
		<!-- <script src="/lenovo3C/Public/Admin/ace/js/ace/ace.sidebar-scroll-1.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.submenu-hover.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.widget-box.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.settings.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.settings-rtl.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.settings-skin.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.widget-on-reload.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.searchbox-autocomplete.js"></script> -->
		<!-- inline scripts related to this page -->

		<!-- the following scripts are used in demo only for onpage help and you don't need them -->
		<!-- <link rel="stylesheet" href="/lenovo3C/Public/Admin/ace/css/ace.onpage-help.css" /> -->

		<!-- <script type="text/javascript"> ace.vars['base'] = '..'; </script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/elements.onpage-help.js"></script>
		<script src="/lenovo3C/Public/Admin/ace/js/ace/ace.onpage-help.js"></script> -->

		<!--引入属于此页面的js -->
		<!-- <script type="text/javascript" src="/lenovo3C/Public/Admin/static/js/myjs/head.js"></script> -->
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="/lenovo3C/Public/Admin/static/js/myjs/index.js"></script>
		...
		<!--引入弹窗组件2start-->
		<!-- <script type="text/javascript" src="/lenovo3C/Public/Admin/plugins/attention/drag/drag.js"></script>
		<script type="text/javascript" src="/lenovo3C/Public/Admin/plugins/attention/drag/dialog.js"></script>
		<link type="text/css" rel="stylesheet" href="/lenovo3C/Public/Admin/plugins/attention/drag/style.css"  /> -->
		<!--引入弹窗组件2end-->
		<script>
		...
		<!--提示框-->
		<script type="text/javascript" src="/lenovo3C/Public/Admin/static/js/jquery.tips.js"></script>
	</body>
</html>