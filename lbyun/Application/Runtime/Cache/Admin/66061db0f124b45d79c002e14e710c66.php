...
<html style="overflow-x:hidden;overflow-y:auto;"><head>
    <title>
        合同单的详细信息 - Powered By Enjoy3C</title>
    ...
    <script src="/yjc/lby/Public/Admin/static/userlist/lenjoy/static/bootstrap/bsie/js/bootstrap-ie.min.js" type="text/javascript"></script><![endif]-->
...
<div>
    <table class="table table-bordered table-striped zdy">
        ...
        <tr>
            ...
            <th>生效时间:</th>
            <td><?php echo ($king["tian_come_time"]); ?>
            </td>
            <th>截止时间:</th>
            <td><?php echo ($king["tian_come_time"]); ?>
            </td>
        ...
        <tr>
            ...
            <th>商品价格:</th>
            <td><?php echo ($king["product_price"]); ?></td>
            <th></th>
            <td></td>
        </tr>
        <tr>
