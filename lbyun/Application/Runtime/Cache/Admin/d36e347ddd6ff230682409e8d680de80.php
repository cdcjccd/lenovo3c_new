                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active  avtive_bold">超时工单</li>
                            <li class="active  avtive_bold"><a href="<?php echo U('Work/finish_list');?>">已完成服务工单</a></li>
                        </ul>
                        <!-- 检索  -->
                        <form action="<?php echo U('Work/over_list');?>" method="post" name="Form" id="Form">
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
                                ...
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                        ...
                                        <!-- <td class='center'><?php echo ($vo["tian_come_time"]); ?></td> -->
                                    
                                        <td class='center'>
                                            <a href="<?php echo U('Renewal/like_list');?>?x_id=<?php echo ($vo['product_id']); ?>">查看合同详情</a> <font color="black">|</font>&nbsp;
                                            <a href="<?php echo U('Renewal/ling_list');?>?p_id=<?php echo ($vo['product_id']); ?>" >更新</a>
                                        </td>
