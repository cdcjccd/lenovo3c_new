...
<link rel="stylesheet" href="/yjc/lby/Public/Home/login/bootstrap.min.css" />
<link rel="stylesheet" href="/yjc/lby/Public/Home/login/css/camera.css" />
<link rel="stylesheet" href="/yjc/lby/Public/Home/login/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="/yjc/lby/Public/Home/login/matrix-login.css" />
<link rel="stylesheet" href="/yjc/lby/Public/Home/public/css/commen.css">
<!-- <link rel="stylesheet" href="login/css/commen.css" /> -->
<link href="/yjc/lby/Public/Home/login/font-awesome.css" rel="stylesheet" />
<script type="text/javascript" src="/yjc/lby/Public/Home/login/js/jquery-1.5.1.min.js"></script>
<!-- 软键盘控件start -->
<link href="/yjc/lby/Public/Home/login/keypad/css/framework/form.css" rel="stylesheet" type="text/css"/>
<!-- 软键盘控件end -->
<!-- input提示框 -->
<script src="/yjc/lby/Public/Home/login/js/jquery-1.11.1.js"></script>
<script src="/yjc/lby/Public/Home/login/js/jquery-validate.js"></script>
<link rel="stylesheet" href="/yjc/lby/Public/Home/login/css/input_tishi.css"/>
<!-- input提示框 -->
 <style type="text/css">
...
<body>
	...
	<div class="loginbox_one">
				...
				<h4 style="padding-bottom:20px;" id="cookmsg">用户登录</h4>
					<div class="controls">
						<div class="main_input_box">
							...
							<i><img height="37" src="/yjc/lby/Public/Home/login/user.png" /></i>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<span class="add-on bg_lg">
							<i><img height="37" src="/yjc/lby/Public/Home/login/suo.png" /></i>
					...
					<div style="width:86%;padding-left:8%;">
                       <div id="yzm" style="display: none">
						<div style="float: left;padding-top:2px;">
							<i><img src="/yjc/lby/Public/Home/login/yan.png" /></i>
						</div>
		...
		<div id="loginbox" style="margin-right:2%;">
			<form class="form_img">
				<a href="#"><img src="/yjc/lby/Public/Home/login/images/img_02.png"></a>
			</form>
		</div>
		...
		<div class="footer" style="margin-top:100px;">
	        <div class="footer_t">
	        	<ul>
	            	<li><img src="/yjc/lby/Public/Home/login/images/lxy_index_29.png"></li>
	                <li><p>十分钟让您拥有云端售后能力</p></li>
	            </ul>
	            <ul>
	            	<li><img src="/yjc/lby/Public/Home/login/images/lxy_index_31.png"></li>
	                <li><p>7*24小时售后顾问支持</p></li>
	            </ul>
	            <ul>
	            	<li><img src="/yjc/lby/Public/Home/login/images/lxy_index_33.png"></li>
	                <li><p>极大降低服务成本</p></li>
	            </ul>
	            <ul>
	            	<li><img src="/yjc/lby/Public/Home/login/images/lxy_index_35.png"></li>
	                <li><p>助你赢取客户忠诚度</p></li>
	            </ul>
	        ...
	        <div class="footer_c">
	        	<ul>
	            	<li><img src="/yjc/lby/Public/Home/login/images/lxy_index_41.png"></li>
	                <li>
	                	<p>服务热线</p>
	                    <p>400-882-2088</p>
	                </li>
				...
				<div class="form-actions">
					<div style="width:60%;padding-left:20%;">
						...
						<span class="pull-right"><a onclick="register();" class="flip-link btn btn-info" id="to-recover">提交</a>
							<!-- <input type="submit" value="提交" class="flip-link btn btn-info" id="to-recover" onclick="register();"> -->
						</span>
					</div>
				</div>
			</form>
...
<!-- input提示框 -->
	...
	function register(){
		   ...
		   if(rcheck()){
			...
			$.ajax({
				type: "POST",
				url: '<?php echo U('Home/Login/addUserHandel');?>',
		    	data: {USERNAME:$("#USERNAME").val(),USER_PROFESSION:$("#profession").val(),MOBILE:$("#MOBILE").val(),
		    		USER_FROM:$("#user_from").val(),PASSWORD:$("#PASSWORD").val(),USER_NAME:$("#name").val(),EMAIL:$("#EMAIL").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',fh,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){
...
<!-- 	// <script src="/yjc/lby/Public/Home/login/js/bootstrap.min.js"></script>
	// <script src="/yjc/lby/Public/Home/js/jquery-1.7.2.js"></script>
	// <script src="/yjc/lby/Public/Home/login/js/jquery.easing.1.3.js"></script>
	// <script src="/yjc/lby/Public/Home/login/js/jquery.mobile.customized.min.js"></script>
	// <script src="/yjc/lby/Public/Home/login/js/camera.min.js"></script>
	// <script src="/yjc/lby/Public/Home/login/js/templatemo_script.js"></script>
	// <script src="/yjc/lby/Public/Home/login/js/ban.js"></script>
	// <script type="text/javascript" src="/yjc/lby/Public/Home/js/jQuery.md5.js"></script>
	// <script type="text/javascript" src="/yjc/lby/Public/Home/js/jquery.tips.js"></script>
	// <script type="text/javascript" src="/yjc/lby/Public/Home/js/jquery.cookie.js"></script> -->

	<!-- 软键盘控件start -->
	<!-- <script type="text/javascript" src="/yjc/lby/Public/Home/login/keypad/js/form/keypad.js"></script>
	<script type="text/javascript" src="/yjc/lby/Public/Home/login/keypad/js/framework.js"></script> -->
	<!-- 软键盘控件end -->
	<!-- 页脚 -->
