...
<meta name="decorator" content="default">
	...
	<form id="searchForm" class="breadcrumb form-search" action="/#/business/export/exportRegisterDownLoad" method="post">
		...
		<div>	
			...
			&nbsp;&nbsp;
			<select id="routeName" name="routeName" onchange="findProductType();" style="width: 150px;">
				<option value="" disabled selected="selected">请选择通路...</option>
			<?php if(is_array($routeName)): foreach($routeName as $key=>$v): ?><option value="<?php echo ($v["code"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
			...
			<input id="btnSubmit" class="btn btn-primary" value="查询" onclick="return page();" type="submit">&nbsp;&nbsp;
				...
				<input id="btnSubmit2" class="btn btn-info submitbutton " value="导出出险" data-loading-text="休息一下..."  type="button">
		...
		<tbody>
				...
				<tr>
					...
					<td>2017-07-05</td>
						...
						<td><a href="<?php echo U('Admin/insuranceOutAnalyze/insDataExportView');?>">查看详细</a></td>
