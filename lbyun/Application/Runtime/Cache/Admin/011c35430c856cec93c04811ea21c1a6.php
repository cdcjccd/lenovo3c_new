					...
					<div class="row">
						...
						<table border="0" cellspacing="0" cellpading="0" class="table-nav-search">
							<tr>
								...
								<td>
									<span>开始时间：</span>
									<input id="d12" name="startTime" onclick="WdatePicker()" placeholder="开始" class="required Wdate span2" value="" maxlength="50" type="text">
								</td>
								<td>
									<span>开始时间：</span>
									<input type="text" id="d13" name="endTime" onclick="WdatePicker()" placeholder="结束时间" class="required Wdate span2" value="" maxlength="50" type="text">
								</td>
								<!-- <td>
									<span>用户姓名：</span>
