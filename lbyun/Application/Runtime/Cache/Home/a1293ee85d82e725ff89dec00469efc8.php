<?php if (!defined('THINK_PATH')) exit();?><form action="<?php echo U('Company/Company_Info_Add');?>" method = 'post' enctype="multipart/form-data"><table>
<tbody><tr>
					    		<td colspan="2" align="left"><h3>公司信息认证</h3></td>
					    	</tr>
					    	<tr>
					    		<td style=" padding-bottom:4px;" width="150px" align="right"><span class="span-red">*</span>&nbsp;企业名称：</td>
					    		<td class="input-01" style="padding-bottom:4px;">
					    			<input name="companyName" id="companyName" placeholder="请输入公司名称" type="text">
					    		</td>
					    	</tr>
					    	<tr>
					    		<td></td>
					    		<td class="jieshi">需与当地政府颁发的商业许可证书或企业注册证上的企业名称完全一致，信息审核审核成功后，企业名称不可修改。</td>
					    	</tr>
					    	<tr>
					    		<td style="padding-bottom:4px;" width="150px" align="right"><span class="span-red">*</span>&nbsp;营业执照注册号：</td>
					    		<td style="padding-bottom:4px;"><input name="cert" id="cert" placeholder="请输入您公司的营业执照注册号" type="text"></td>
					    	</tr>
					    	<tr>
					    		<td></td>
					    		<td class="jieshi">请输入15位营业执照注册号或18位的统一社会信用代码</td>
					    	</tr>
					    	
					    	<tr>
					    		<td width="150px" align="right"><span class="span-red">*</span>&nbsp;营业执照扫描件：</td>
					    		
					    		<td id="pic" class="jieshi jieshi_01"><span id="div1">请上传营业执照清晰彩色原件扫描件或数码照在有效期内且年检章齐全（当年成立的可无年检章）由中国大陆工商局或市场监督管理局颁发
					 				支持.jpg .jpeg .png 格式照片，大小不超过5M。</span>
					 				<input id="compicture" name="compicture" type="hidden">
								    <div class="form-group">
								       <div id="comdiv" style="display: none">
								        
								       </div>
								        <div class="col-sm-9">
								            <input value="上传图片" id="tpcom" name="tp" onclick="picturecom()" type="file">
								        </div>
								    </div>
					    	...
					    	<tr>
					    		<td width="150px" align="right"><span class="span-red">*</span>&nbsp;企业网址：</td>
					    		<td><input name="companyUrl" id="companyUrl" placeholder="请输入您的企业网址" type="text"></td>
					    	</tr>
					    	<tr>
					    		<td width="150px" align="right"><span class="span-red">*</span>&nbsp;国家地区：</td>
					    		<td>
					    			<!-- <input type="text" name="country" id="country"  value="中国" placeholder="" onfocus=this.blur()> -->
										    			<select id="country" name="country" class="select_gallery">
														 <option selected="selected" id="coun" value="">-选择国家/地区-</option>
					    	...
					    	<tr>
					    		...
					    		<td>
	                                  <select name="COMPANY_TYPE" id="company_type">
										  ...
										  <option>售后服务公司</option>
										  <option>其他公司</option>
										</select>
					    		  </td>
					    	</tr>
					    	<tr>
					    		<td width="150px" align="right"><span class="span-red">*</span>&nbsp;街道地址：</td>
					    		<td><input name="streetAddress" id="streetAddress" placeholder="" type="text"></td>
					    	</tr>
					    	<tr>
					    		<td width="150px" align="right"><span class="span-red">*</span>&nbsp;公司电话：</td>
					    		<td><input class="required" data-tip="区号-固定电话" data-valid="isNonEmpty||isEmail" data-error="公司电话不能为空" name="companyTel" id="companyTel" placeholder="" type="text"></td>
					    	</tr>
					    	<tr>
							<td></td>
