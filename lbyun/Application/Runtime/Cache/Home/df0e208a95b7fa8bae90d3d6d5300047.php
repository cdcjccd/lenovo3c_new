...
<link rel="stylesheet" href="/Public/Home/login/bootstrap.min.css" />
<link rel="stylesheet" href="/Public/Home/login/css/camera.css" />
<link rel="stylesheet" href="/Public/Home/login/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="/Public/Home/login/matrix-login.css" />
<link rel="stylesheet" href="/Public/Home/public/css/commen.css">
<!-- <link rel="stylesheet" href="login/css/commen.css" /> -->
<link href="/Public/Home/login/font-awesome.css" rel="stylesheet" />
<script type="text/javascript" src="/Public/Home/login/js/jquery-1.5.1.min.js"></script>
<!-- 软键盘控件start -->
<link href="/Public/Home/login/keypad/css/framework/form.css" rel="stylesheet" type="text/css"/>
<!-- 软键盘控件end -->
<!-- input提示框 -->
<script src="/Public/Home/login/js/jquery-1.11.1.js"></script>
<script src="/Public/Home/login/js/jquery-validate.js"></script>
<link rel="stylesheet" href="/Public/Home/login/css/input_tishi.css"/>
<!-- input提示框 -->
 <style type="text/css">
...
<body>
	...
	<div class="nav">
	    	<a href="index.html" target="_blank">
	    		<img class="logo" src="/Public/Home/public/images/logo.png">
	    		<img class="logo" src="/Public/Home/public/images/05.gif" style="height:36px; margin-left:20px;">
	    	</a>
	    	<p>Beta</p>
	        <ul class="nav_center">
	...
	<div class="loginbox_one">
				...
				<h4 style="padding-bottom:20px;" id="cookmsg">用户登录</h4>
					<div class="controls">
						<div class="main_input_box">
							...
							<i><img height="37" src="/Public/Home/login/user.png" /></i>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<span class="add-on bg_lg">
							<i><img height="37" src="/Public/Home/login/suo.png" /></i>
					...
					<div style="width:86%;padding-left:8%;">
                       <div id="yzm" style="display: none">
						<div style="float: left;padding-top:2px;">
							<i><img src="/Public/Home/login/yan.png" /></i>
						</div>
		...
		<div id="loginbox" style="margin-right:2%;">
			<form class="form_img">
				<a href="#"><img src="/Public/Home/login/images/img_02.png"></a>
			</form>
		</div>
		...
		<div class="footer" style="margin-top:100px;">
	        <div class="footer_t">
	        	<ul>
	            	<li><img src="/Public/Home/login/images/lxy_index_29.png"></li>
	                <li><p>十分钟让您拥有云端售后能力</p></li>
	            </ul>
	            <ul>
	            	<li><img src="/Public/Home/login/images/lxy_index_31.png"></li>
	                <li><p>7*24小时售后顾问支持</p></li>
	            </ul>
	            <ul>
	            	<li><img src="/Public/Home/login/images/lxy_index_33.png"></li>
	                <li><p>极大降低服务成本</p></li>
	            </ul>
	            <ul>
	            	<li><img src="/Public/Home/login/images/lxy_index_35.png"></li>
	                <li><p>助你赢取客户忠诚度</p></li>
	            </ul>
	            <div class="clearfix"></div>
	        </div>
	        <div class="footer_c">
	        	<ul>
	            	<li><img src="/Public/Home/login/images/lxy_index_41.png"></li>
	                <li>
	                	<p>服务热线</p>
	                    <p>400-882-2088</p>
	                </li>
	        ...
	        <div class="footer_b">
	            <span>Copyright&nbsp;&nbsp;联保云&nbsp;版权所有2016&nbsp;&nbsp;<a target="_blank" href="http://www.miitbeian.gov.cn/">京ICP备16042723号-1</a>&nbsp;&nbsp;
		 		<a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802022735">
		 			<img src="http://www.lbyun.com:80/welcome/images/record.png">
...
<!-- input提示框 -->
	...
	<script src="login/js/ban.js"></script>
	<script type="text/javascript" src="js/jQuery.md5.js"></script>
	<script type="text/javascript" src="js/jquery.tips.js"></script>
	<script type="text/javascript" src="js/jquery.cookie.js"></script>

	<!-- 软键盘控件start -->
	<script type="text/javascript" src="login/keypad/js/form/keypad.js"></script>
	<script type="text/javascript" src="login/keypad/js/framework.js"></script>
	<!-- 软键盘控件end -->
	<!-- 页脚 -->
